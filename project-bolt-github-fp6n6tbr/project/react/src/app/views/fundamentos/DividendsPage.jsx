...
import HistoricalDY from "./HistoricalDY";
      ...
      <Box my={4}>
        ...
        <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
          ...
          <Typography variant="body1" paragraph>
            Compare os rendimentos históricos dos dividendos de várias ações ao longo do tempo. 
            Selecione uma ou mais ações para visualizar o desempenho dos seus dividendos.
          </Typography>
          <HistoricalDY />
        </Paper>        
        <Paper elevation={3} sx={{ p: 3 }}>
          ...
          <Typography variant="body1" paragraph>
            Analisar o histórico de dividendos pode fornecer insights valiosos sobre a saúde financeira 
            de uma empresa e a criação de valor para os acionistas. Aqui estão alguns pontos-chave a considerar:
          </Typography>
          <ul>
